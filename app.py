...
st.subheader("Funding & Salary Breakdown (Data Sources)")

breakdown_df = final_df[[
    "FY Label",
    "Internal Funding",
    "Statistics (COS)",
    "External CBHDS Funding",
    "Salary Expenses"
]].copy()

# Add total column (matches stacked bar total)
breakdown_df["Total Funding Stack"] = (
    breakdown_df["Internal Funding"] +
    breakdown_df["Statistics (COS)"] +
    breakdown_df["External CBHDS Funding"]
)

# Rename columns for clarity
breakdown_df = breakdown_df.rename(columns={
    "FY Label": "Fiscal Year",
    "Internal Funding": "Internal Funding (Internal Funding Sheet)",
    "Statistics (COS)": "Statistics (COS - Salaries Sheet)",
    "External CBHDS Funding": "External Funding (Grants + Contracts)",
    "Salary Expenses": "Salary Expenses (Salaries Sheet)"
})

# Format as currency
currency_cols = [
    "Internal Funding (Internal Funding Sheet)",
    "Statistics (COS - Salaries Sheet)",
    "External Funding (Grants + Contracts)",
    "Salary Expenses (Salaries Sheet)",
    "Total Funding Stack"
]
